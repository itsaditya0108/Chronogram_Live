...
public class AdminUserListResponse {
    ...
    public AdminUserListResponse(Long userId, String name, String email, String phone,
            String status, boolean emailVerified, boolean phoneVerified, LocalDateTime createdTimestamp,
            long imageTotalFiles, long imageTotalBytes, long videoTotalFiles, long videoTotalBytes) {
        this.userId = userId;
        this.name = name;
        this.email = email;
        this.phone = phone;
    ...
    public long getImageTotalFiles() {
        return imageTotalFiles;
    }

    public long getImageTotalBytes() {
